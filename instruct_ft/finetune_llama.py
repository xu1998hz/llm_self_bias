...
parser.add_argument("--run_name", type=str, default='some name')
...
f = f"/home/guangleizhu/peril_self_improve/instruct_ft/data/ift_mqm.json"
print(f'loading from {f}')
output_dir = f"ckpt/{args.run_name}" 
