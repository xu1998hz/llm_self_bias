...
parser.add_argument("--run_name", type=str, help="mistral ft test")
parser.add_argument("--deepspeed", type=str, default='--', help="")
parser.add_argument('--local_rank', type=int, default=-1, help='local rank passed from distributed launcher')
args = parser.parse_args()

run_name = args.run_name
f = f"data/wmt21_ref_train_all_error.json"
...
# print(f"number of data that has more than 720 context: {c}")
